import{r as f,j as qe}from"./motion-BQn0b-3B.js";const o={colors:["#3b0f6f","#8b2fc9","#e84a8a","#ffae5c"],speed:.6,scale:.5,seed:8,turbAmp:.5,turbFreq:.6,turbIter:8,waveFreq:2.5,distBias:.1,jellify:0,ditherMode:"smooth",dither:.06,exposure:1.2,contrast:1.15,saturation:1.1,loop:0},je={sunset:{...o,colors:["#3b0f6f","#8b2fc9","#e84a8a","#ffae5c"]},subtleDark:{...o,colors:["#050505","#0f0f0f","#0a0a0a","#1a1a1a","#141414"],speed:1,scale:.4,seed:3,ditherMode:"off",exposure:1.1,contrast:1.1,saturation:1,distBias:0},vibrant:{...o,colors:["#ff0055","#0055ff","#00ffaa","#ffaa00","#7700ff"],seed:42,contrast:1.2,saturation:1.2},aurora:{...o,colors:["#051105","#0a3311","#055533","#11aa44","#0a1122"],speed:.4,scale:.6,seed:12,turbAmp:.6,turbFreq:.8,turbIter:10,waveFreq:1.5,distBias:-.2,ditherMode:"grain",dither:.04,exposure:1.3},magma:{...o,colors:["#110000","#330500","#661100","#aa3300","#ff6600"],speed:.8,scale:.3,seed:7,waveFreq:3,distBias:.3,contrast:1.3,saturation:1.3}},Be=`#version 300 es
