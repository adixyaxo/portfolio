...
var require_Node = __commonJS({
  "node_modules/controlkit/lib/core/document/Node.js"(exports, module) {
    function Node() {
      this._element = null;
    ...
    Node.prototype = {
      ...
      getPositionGlobal: function() {
        var offset = [0, 0], element = this._element;
        while (element) {
      ...
      getPositionGlobalX: function() {
        var offset = 0, element = this._element;
        while (element) {
...
var require_EventDispatcher = __commonJS({
  "node_modules/controlkit/lib/core/event/EventDispatcher.js"(exports, module) {
    ...
    EventDispatcher.prototype = {
      ...
      hasEventListener: function(type) {
        return this._listeners[type] != void 0 && this._listeners[type] != null;
      }
    };
...
var require_Metric = __commonJS({
  "node_modules/controlkit/lib/component/Metric.js"(exports, module) {
    var Metric = {
...
var require_CSS = __commonJS({
  "node_modules/controlkit/lib/core/document/CSS.js"(exports, module) {
    var CSS = {
...
var require_DocumentEvent = __commonJS({
  "node_modules/controlkit/lib/core/document/DocumentEvent.js"(exports, module) {
    var DocumentEvent = {
...
var require_NodeEvent = __commonJS({
  "node_modules/controlkit/lib/core/document/NodeEvent.js"(exports, module) {
    var NodeEvent = {
      MOUSE_DOWN: "mousedown",
      MOUSE_UP: "mouseup",
...
var require_Event = __commonJS({
  "node_modules/controlkit/lib/core/event/Event.js"(exports, module) {
...
var require_Mouse = __commonJS({
  "node_modules/controlkit/lib/core/document/Mouse.js"(exports, module) {
    var EventDispatcher = require_EventDispatcher();
    var Event_ = require_Event();
    var DocumentEvent = require_DocumentEvent();
    var instance = null;
    function Mouse() {
...
var require_ScrollBar = __commonJS({
  "node_modules/controlkit/lib/core/layout/ScrollBar.js"(exports, module) {
    var Node = require_Node();
    var Metric = require_Metric();
    var CSS = require_CSS();
    var DocumentEvent = require_DocumentEvent();
    var NodeEvent = require_NodeEvent();
    var Mouse = require_Mouse();
    function ScrollBar(parentNode, targetNode, wrapHeight) {
      this._parentNode = parentNode;
      this._targetNode = targetNode;
      this._wrapHeight = wrapHeight;
      var wrap = this._wrapNode = new Node().setStyleClass(CSS.ScrollWrap), node = this._node = new Node().setStyleClass(CSS.ScrollBar), track = this._trackNode = new Node().setStyleClass(CSS.ScrollBarTrack), thumb = this._thumbNode = new Node().setStyleClass(CSS.ScrollBarThumb);
      ...
      this._isValid = false;
      this._enabled = false;
      var nodeElement = node.getElement(), thumbElement = thumb.getElement();
      var self = this;
      this._onMouseWheel = function(e) {
        var sender = e.sender, hoverElement = sender.getHoverElement();
    ...
    ScrollBar.prototype.update = function() {
      var target = this._targetNode, thumb = this._thumbNode;
      var padding = Metric.SCROLLBAR_TRACK_PADDING;
      var targetWrapHeight = this._wrapHeight, targetHeight = target.getHeight(), trackHeight = targetWrapHeight - padding * 2;
    ...
    ScrollBar.prototype._scroll = function(y) {
      var min = this._scrollMin, max = this._scrollMax, pos = Math.max(min, Math.min(y, max)), pos_ = (pos - min) / (max - min);
    ...
    ScrollBar.prototype._onThumbDragStart = function() {
      ...
      var eventMove = DocumentEvent.MOUSE_MOVE, eventUp = DocumentEvent.MOUSE_UP;
      var mouse = Mouse.get();
    ...
    ScrollBar.prototype.removeFromParent = function() {
      var parentNode = this._parentNode, rootNode = this._node, targetNode = this._targetNode;
...
var require_AbstractGroup = __commonJS({
  "node_modules/controlkit/lib/group/AbstractGroup.js"(exports, module) {
    var EventDispatcher = require_EventDispatcher();
    var Node = require_Node();
    ...
    function AbstractGroup(parent, params) {
      ...
      params.enable = params.enable === void 0 ? true : params.enable;
      this._parent = parent;
    ...
    AbstractGroup.prototype.addScrollWrap = function() {
      var wrapNode = this._wrapNode, maxHeight = this.getMaxHeight();
...
var require_PanelEvent = __commonJS({
  "node_modules/controlkit/lib/group/PanelEvent.js"(exports, module) {
    var PanelEvent = {
...
var require_GroupEvent = __commonJS({
  "node_modules/controlkit/lib/group/GroupEvent.js"(exports, module) {
    var GroupEvent = {
...
var require_ComponentEvent = __commonJS({
  "node_modules/controlkit/lib/core/ComponentEvent.js"(exports, module) {
    var ComponentEvent = {
...
var require_SubGroup = __commonJS({
  "node_modules/controlkit/lib/group/SubGroup.js"(exports, module) {
    var AbstractGroup = require_AbstractGroup();
    var Node = require_Node();
    var CSS = require_CSS();
    var Event_ = require_Event();
    var DocumentEvent = require_DocumentEvent();
    var PanelEvent = require_PanelEvent();
    var GroupEvent = require_GroupEvent();
    var ComponentEvent = require_ComponentEvent();
    function SubGroup(parent, params) {
      params = params || {};
      params.label = params.label || null;
      params.useLabels = params.useLabels === void 0 ? true : params.useLabels;
      AbstractGroup.apply(this, arguments);
      var rootNode = this._node, wrapNode = this._wrapNode, listNode = this._listNode;
      ...
      if (label && label.length != 0 && label != "none") {
        var headNode = this._headNode = new Node(), lablWrap = new Node(), lablNode = new Node(Node.SPAN);
    ...
    SubGroup.prototype._onHeadMouseDown = function() {
      ...
      this._onTrigger();
      var event = DocumentEvent.MOUSE_UP, self = this;
...
var require_HistoryEvent = __commonJS({
  "node_modules/controlkit/lib/core/HistoryEvent.js"(exports, module) {
    var HistoryEvent = {
...
var require_History = __commonJS({
  "node_modules/controlkit/lib/core/History.js"(exports, module) {
    var EventDispatcher = require_EventDispatcher();
    var Event_ = require_Event();
    var HistoryEvent = require_HistoryEvent();
    var MAX_STATES = 30;
    function History() {
      EventDispatcher.apply(this, arguments);
      this._states = [];
...
var require_Component = __commonJS({
  "node_modules/controlkit/lib/core/Component.js"(exports, module) {
    var Node = require_Node();
    var CSS = require_CSS();
    var EventDispatcher = require_EventDispatcher();
    var ComponentEvent = require_ComponentEvent();
    function Component(parent, label) {
      ...
      this._parent = parent;
      this._enabled = true;
      var root = this._node = new Node(Node.LIST_ITEM), wrap = this._wrapNode = new Node();
...
var require_OptionEvent = __commonJS({
  "node_modules/controlkit/lib/core/OptionEvent.js"(exports, module) {
    var OptionEvent = {
...
var require_ObjectComponentNotifier = __commonJS({
  "node_modules/controlkit/lib/core/ObjectComponentNotifier.js"(exports, module) {
    var EventDispatcher = require_EventDispatcher();
    var Event_ = require_Event();
    var ComponentEvent = require_ComponentEvent();
    var OptionEvent = require_OptionEvent();
...
var require_ComponentObjectError = __commonJS({
  "node_modules/controlkit/lib/core/ComponentObjectError.js"(exports, module) {
...
var require_ObjectComponent = __commonJS({
  "node_modules/controlkit/lib/core/ObjectComponent.js"(exports, module) {
    var History = require_History();
    var Component = require_Component();
    var ComponentEvent = require_ComponentEvent();
    var ObjectComponentNotifier = require_ObjectComponentNotifier();
    var ComponentObjectError = require_ComponentObjectError();
    var Event_ = require_Event();
...
var require_SVGComponent = __commonJS({
  "node_modules/controlkit/lib/component/SVGComponent.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var CSS = require_CSS();
    var GroupEvent = require_GroupEvent();
    var Metric = require_Metric();
...
var require_Plotter = __commonJS({
  "node_modules/controlkit/lib/component/Plotter.js"(exports, module) {
    var SVGComponent = require_SVGComponent();
...
var require_ValuePlotter = __commonJS({
  "node_modules/controlkit/lib/component/ValuePlotter.js"(exports, module) {
    var Plotter = require_Plotter();
    var Metric = require_Metric();
    var DEFAULT_RESOLUTION = 1;
    function ValuePlotter(parent, object, value, params) {
      Plotter.apply(this, arguments);
      var svg = this._svg, svgWidth = Number(svg.getAttribute("width")), svgHeight = Number(svg.getAttribute("height"));
      params = params || {};
      params.height = params.height || svgHeight;
      params.resolution = params.resolution || DEFAULT_RESOLUTION;
      var resolution = params.resolution, length = Math.floor(svgWidth / resolution);
      var points = this._points = new Array(length * 2), buffer0 = this._buffer0 = new Array(length), buffer1 = this._buffer1 = new Array(length);
    ...
    ValuePlotter.prototype._redraw = function() {
      var points = this._points, bufferLen = this._buffer0.length;
      var width = Number(this._svg.getAttribute("width")), ratio = width / (bufferLen - 1);
      var i = -1;
      while (++i < bufferLen) {
    ...
    ValuePlotter.prototype.onGroupSizeChange = function() {
      var width = this._wrapNode.getWidth(), height = this._height;
    ...
    ValuePlotter.prototype._drawGrid = function() {
      var svg = this._svg;
      var svgWidth = Number(svg.getAttribute("width")), svgHeightHalf = Math.floor(Number(svg.getAttribute("height")) * 0.5);
      var pathCmd = "";
    ...
    ValuePlotter.prototype._drawCurve = function() {
      ...
      var buffer0 = this._buffer0, buffer1 = this._buffer1, points = this._points;
      var bufferLength = buffer0.length;
      var pathCmd = "";
      var heightHalf = Number(svg.getAttribute("height")) * 0.5, unit = heightHalf - this._lineWidth * 0.5;
      points[1] = buffer0[0];
...
var require_FunctionPlotType = __commonJS({
  "node_modules/controlkit/lib/component/FunctionPlotType.js"(exports, module) {
...
var require_FunctionPlotterObjectError = __commonJS({
  "node_modules/controlkit/lib/component/FunctionPlotterObjectError.js"(exports, module) {
...
var require_FunctionPlotterFunctionArgsError = __commonJS({
  "node_modules/controlkit/lib/component/FunctionPlotterFunctionArgsError.js"(exports, module) {
...
var require_FunctionPlotter = __commonJS({
  "node_modules/controlkit/lib/component/FunctionPlotter.js"(exports, module) {
    var Plotter = require_Plotter();
    var Node = require_Node();
    var CSS = require_CSS();
    var FunctionPlotType = require_FunctionPlotType();
    var Mouse = require_Mouse();
    var Metric = require_Metric();
    var DocumentEvent = require_DocumentEvent();
    var ComponentEvent = require_ComponentEvent();
    var NodeEvent = require_NodeEvent();
    var FunctionPlotterObjectError = require_FunctionPlotterObjectError();
    var FunctionPlotterFunctionArgsError = require_FunctionPlotterFunctionArgsError();
    var ObjectComponentNotifier = require_ObjectComponentNotifier();
    var DEFAULT_SHOW_MIN_MAX_LABELS = true;
    var DEFAULT_FUNCTION_PLOTTER_NON_IMPLICIT_UNIT_X = 1;
    var DEFAULT_FUNCTION_PLOTTER_NON_IMPLICIT_UNIT_Y = 1;
    var DEFAULT_FUNCTION_PLOTTER_IMPLICIT_UNIT_X = 0.25;
    var DEFAULT_FUNCTION_PLOTTER_IMPLICIT_UNIT_Y = 0.25;
    var DEFAULT_FUNCTION_PLOTTER_UNIT_MIN = 0.15;
    var DEFAULT_FUNCTION_PLOTTER_UNIT_MAX = 4;
    var DEFAULT_FUNCTION_PLOTTER_NON_IMPLICIT_SCALE = 10;
    var DEFAULT_FUNCTION_PLOTTER_IMPLICIT_SCALE = 1;
    var DEFAULT_FUNCTION_PLOTTER_SCALE_MIN = 0.02;
    var DEFAULT_FUNCTION_PLOTTER_SCALE_MAX = 25;
    var DEFAULT_FUNCTION_PLOTTER_IMPLICIT_AXES_COLOR = "rgba(255,255,255,0.75)";
    var DEFAULT_FUNCTION_PLOTTER_IMPLICIT_GRID_COLOR = "rgba(25,25,25,0.75)";
    var DEFAULT_FUNCTION_PLOTTER_NON_IMPLICIT_AXES_COLOR = "rgb(54,60,64)";
    var DEFAULT_FUNCTION_PLOTTER_NON_IMPLICIT_GRID_COLOR = "rgb(25,25,25)";
    function FunctionPlotter(parent, object, value, params) {
      params = params || {};
      params.showMinMaxLabels = params.showMinMaxLabels === void 0 ? DEFAULT_SHOW_MIN_MAX_LABELS : params.showMinMaxLabels;
      Plotter.apply(this, arguments);
      ...
      var svgRoot = this._svgRoot, path = this._path;
      ...
      var grid = this._grid;
      var svg = this._svg, size = Number(svg.getAttribute("width"));
      ...
      this._unitsMinMax = [DEFAULT_FUNCTION_PLOTTER_UNIT_MIN, DEFAULT_FUNCTION_PLOTTER_UNIT_MAX];
      this._scaleMinMax = [DEFAULT_FUNCTION_PLOTTER_SCALE_MIN, DEFAULT_FUNCTION_PLOTTER_SCALE_MAX];
    ...
    FunctionPlotter.prototype._updateCenter = function() {
      var svg = this._svg, width = Number(svg.getAttribute("width")), height = Number(svg.getAttribute("height"));
      var mousePos = Mouse.get().getPosition(), svgPos = this._svgPos, center = this._center;
    ...
    FunctionPlotter.prototype._onDragStart = function(e) {
      ...
      var eventMove = DocumentEvent.MOUSE_MOVE, eventUp = DocumentEvent.MOUSE_UP;
      var onDrag = this._updateCenter.bind(this), onDragEnd = (function() {
    ...
    FunctionPlotter.prototype._redraw = function() {
      if (this._plotMode == FunctionPlotType.IMPLICIT) {
        var size = this._wrapNode.getWidth(), canvas = this._canvas;
        canvas.style.width = canvas.style.height = size + "px";
        canvas.width = canvas.height = size;
        this._canvasImageData = this._canvasContext.getImageData(0, 0, size, size);
      }
    ...
    FunctionPlotter.prototype._drawAxes = function() {
      var svg = this._svg, svgWidth = Number(svg.getAttribute("width")), svgHeight = Number(svg.getAttribute("height"));
      var center = this._center, centerX = center[0], centerY = center[1];
      var pathCmd = "";
    ...
    FunctionPlotter.prototype._drawPlot = function() {
      var width, height;
      var center = this._center, centerX = center[0], centerY = center[1];
      var units = this._units, unitX, unitY;
      ...
      if (this._plotMode == FunctionPlotType.NON_IMPLICIT) {
        ...
        var len = Math.floor(width), points = new Array(len * 2);
        i = -1;
        while (++i < len) {
        ...
        var canvas = this._canvas, context = this._canvasContext, imgData = this._canvasImageData;
        width = canvas.width;
        ...
        var invWidth = 1 / width, invHeight = 1 / height;
        var rgb = [0, 0, 0];
        var col0 = [30, 34, 36], col1 = [255, 255, 255];
        i = -1;
        var j;
        while (++i < height) {
          j = -1;
    ...
    FunctionPlotter.prototype._drawGrid = function() {
      var svg = this._svg, width = Number(svg.getAttribute("width")), height = Number(svg.getAttribute("height"));
      var scale = this._scale;
      var gridRes = this._units, gridSpacingX = width / (gridRes[0] * scale), gridSpacingY = height / (gridRes[1] * scale);
      var center = this._center, centerX = center[0], centerY = center[1];
      var gridNumTop = Math.round(centerY / gridSpacingY) + 1, gridNumBottom = Math.round((height - centerY) / gridSpacingY) + 1, gridNumLeft = Math.round(centerX / gridSpacingX) + 1, gridNumRight = Math.round((width - centerX) / gridSpacingX) + 1;
      var pathCmdGrid = "", pathCmdAxesLabels = "";
      var i, temp;
    ...
    FunctionPlotter.prototype._sliderXStep = function(mousePos) {
      ...
      var handle = this._sliderXHandle, handleWidth = handle.getWidth(), handleWidthHalf = handleWidth * 0.5;
      var track = this._sliderXTrack, trackWidth = track.getWidth(), trackLeft = track.getPositionGlobalX();
      var strokeSize = Metric.STROKE_SIZE;
      var max = trackWidth - handleWidthHalf - strokeSize * 2;
      var pos = Math.max(handleWidthHalf, Math.min(mouseX - trackLeft, max)), handlePos = pos - handleWidthHalf;
      handle.setPositionX(handlePos);
      var unitsMin = this._unitsMinMax[0], unitsMax = this._unitsMinMax[1];
      var normVal = (pos - handleWidthHalf) / (max - handleWidthHalf), mappedVal = unitsMin + (unitsMax - unitsMin) * normVal;
      this._units[0] = mappedVal;
      this._plotGraph();
    };
    FunctionPlotter.prototype._sliderYStep = function(mousePos) {
      var mouseY = mousePos[1];
      var handle = this._sliderYHandle, handleHeight = handle.getHeight(), handleHeightHalf = handleHeight * 0.5;
      var track = this._sliderYTrack, trackHeight = track.getHeight(), trackTop = track.getPositionGlobalY();
      var max = trackHeight - handleHeightHalf - 2;
      var pos = Math.max(handleHeightHalf, Math.min(mouseY - trackTop, max)), handlePos = pos - handleHeightHalf;
      handle.setPositionY(handlePos);
      var unitsMax = this._unitsMinMax[0], unitsMin = this._unitsMinMax[1];
      var normVal = (pos - handleHeightHalf) / (max - handleHeightHalf), mappedVal = unitsMin + (unitsMax - unitsMin) * normVal;
    ...
    FunctionPlotter.prototype._onSliderHandleDown = function(sliderStepFunc) {
      var eventMouseMove = DocumentEvent.MOUSE_MOVE, eventMouseUp = DocumentEvent.MOUSE_UP;
      var mouse = Mouse.get();
      var onDrag = function() {
    ...
    FunctionPlotter.prototype._sliderXHandleUpdate = function() {
      var unitMin = this._unitsMinMax[0], unitMax = this._unitsMinMax[1], unitX = this._units[0];
      var handleX = this._sliderXHandle, handleXWidth = handleX.getWidth(), handleXWidthHalf = handleXWidth * 0.5, trackXWidth = this._sliderXTrack.getWidth();
      var strokeSize = Metric.STROKE_SIZE;
      var handleXMin = handleXWidthHalf, handleXMax = trackXWidth - handleXWidthHalf - strokeSize * 2;
    ...
    FunctionPlotter.prototype._sliderYHandleUpdate = function() {
      var unitMin = this._unitsMinMax[0], unitMax = this._unitsMinMax[1], unitY = this._units[1];
      var handleY = this._sliderYHandle, handleYHeight = handleY.getHeight(), handleYHeightHalf = handleYHeight * 0.5, trackYHeight = this._sliderYTrack.getHeight();
      var strokeSize = Metric.STROKE_SIZE;
      var handleYMin = trackYHeight - handleYHeightHalf - strokeSize * 2, handleYMax = handleYHeightHalf;
...
var require_Group = __commonJS({
  "node_modules/controlkit/lib/group/Group.js"(exports, module) {
    var AbstractGroup = require_AbstractGroup();
    var CSS = require_CSS();
    var Node = require_Node();
    var SubGroup = require_SubGroup();
    var Event_ = require_Event();
    var DocumentEvent = require_DocumentEvent();
    var NodeEvent = require_NodeEvent();
    var PanelEvent = require_PanelEvent();
    var GroupEvent = require_GroupEvent();
    var ObjectComponent = require_ObjectComponent();
    var ValuePlotter = require_ValuePlotter();
    var FunctionPlotter = require_FunctionPlotter();
    function Group(parent, params) {
      ...
      this._components = [];
      this._subGroups = [];
      var root = this._node, wrap = this._wrapNode, list = this._listNode;
      ...
      var label = params.label;
      if (label) {
        var head = new Node(), wrap_ = new Node(), label_ = new Node(Node.SPAN), indicator = this._indiNode = new Node();
    ...
    Group.prototype.onSubGroupTrigger = function() {
      ...
      var scrollBar = this._scrollBar, wrap = this._wrapNode;
      var bufferTop = this._scrollBufferTop, bufferBottom = this._scrollBufferBottom;
      scrollBar.update();
    ...
    Group.prototype._updateAppearance = function() {
      var wrap = this._wrapNode, indicator = this._indiNode;
      ...
      if (this.hasMaxHeight()) {
        var maxHeight = this.getMaxHeight(), listHeight = wrap.getChildAt(1).getHeight();
    ...
    Group.prototype.getData = function() {
      var comps = this._components, i = -1, l = comps.length;
      var values = [];
      var comp;
      while (++i < l) {
        comp = comps[i];
...
var require_LayoutMode = __commonJS({
  "node_modules/controlkit/lib/core/layout/LayoutMode.js"(exports, module) {
    var LayoutMode = {
      LEFT: "left",
      RIGHT: "right",
      TOP: "top",
...
var require_MenuEvent = __commonJS({
  "node_modules/controlkit/lib/group/MenuEvent.js"(exports, module) {
    var MenuEvent = {
...
var require_ColorMode = __commonJS({
  "node_modules/controlkit/lib/core/color/ColorMode.js"(exports, module) {
    var ColorMode = {
      RGB: "rgb",
      HSV: "hsv",
      HEX: "hex",
...
var require_ColorUtil = __commonJS({
  "node_modules/controlkit/lib/core/color/ColorUtil.js"(exports, module) {
    var ColorUtil = {
      HSV2RGB: function(hue, sat, val) {
        var max_hue = 360, max_sat = 100, max_val = 100;
        var min_hue = 0, min_sat = 0, min_val = 0;
        hue = hue % max_hue;
        ...
        sat = sat / max_sat;
        var hi = Math.floor(hue / 60) % 6, f = hue / 60 - hi, p = val * (1 - sat), q = val * (1 - f * sat), t = val * (1 - (1 - f) * sat);
        var r = 0, g = 0, b = 0;
        switch (hi) {
          case 0:
            r = val;
      ...
      RGB2HSV: function(r, g, b) {
        ...
        g = g / 255;
        b = b / 255;
        var minRGB = Math.min(r, Math.min(g, b)), maxRGB = Math.max(r, Math.max(g, b));
        if (minRGB == maxRGB) {
          v = minRGB;
          return [0, 0, Math.round(v)];
        }
        var dd = r == minRGB ? g - b : b == minRGB ? r - g : b - r, hh = r == minRGB ? 3 : b == minRGB ? 1 : 5;
...
var require_Options = __commonJS({
  "node_modules/controlkit/lib/component/Options.js"(exports, module) {
    var Node = require_Node();
    var DocumentEvent = require_DocumentEvent();
    var NodeEvent = require_NodeEvent();
    var CSS = require_CSS();
    var ColorMode = require_ColorMode();
    var ColorUtil = require_ColorUtil();
    var Metric = require_Metric();
    ...
    Options.prototype = {
      ...
      build: function(entries, selected, element, callbackSelect, callbackOut, paddingRight, areColors, colorMode) {
        ...
        var rootNode = this._node, listNode = this._listNode;
        ...
        var elementPos = element.getPositionGlobal(), elementWidth = element.getWidth() - paddingRight, elementHeight = element.getHeight();
        var listWidth = listNode.getWidth(), listHeight = listNode.getHeight(), strokeOffset = Metric.STROKE_SIZE * 2;
        var paddingOptions = Metric.PADDING_OPTIONS;
        var width = (listWidth < elementWidth ? elementWidth : listWidth) - strokeOffset, posX = elementPos[0], posY = elementPos[1] + elementHeight - paddingOptions;
        var windowWidth = window.innerWidth, windowHeight = window.innerHeight;
        var rootPosX = posX + width > windowWidth ? posX - width + elementWidth - strokeOffset : posX, rootPosY = posY + listHeight > windowHeight ? posY - listHeight * 0.5 - elementHeight * 0.5 : posY;
...
var require_ButtonPreset = __commonJS({
  "node_modules/controlkit/lib/component/ButtonPreset.js"(exports, module) {
    var EventDispatcher = require_EventDispatcher();
    var ObjectComponentNotifier = require_ObjectComponentNotifier();
    var Event_ = require_Event();
    var OptionEvent = require_OptionEvent();
    ...
    function ButtonPreset(parentNode) {
      EventDispatcher.apply(this);
      var node = this._btnNode = new Node(Node.INPUT_BUTTON), imgNode = this._indiNode = new Node();
...
var require_StringInput = __commonJS({
  "node_modules/controlkit/lib/component/StringInput.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var Node = require_Node();
    var CSS = require_CSS();
    var Options = require_Options();
    var ButtonPreset = require_ButtonPreset();
    var Metric = require_Metric();
    var Event_ = require_Event();
    var DocumentEvent = require_DocumentEvent();
    var NodeEvent = require_NodeEvent();
    ...
    function StringInput(parent, object, value, params) {
      ...
      if (!presets) {
        ...
        var options = Options.get(), btnPreset = new ButtonPreset(this._wrapNode);
...
var require_NumberInput_Internal = __commonJS({
  "node_modules/controlkit/lib/component/NumberInput_Internal.js"(exports, module) {
    var EventDispatcher = require_EventDispatcher();
    var NodeEvent = require_NodeEvent();
    var Node = require_Node();
    ...
    NumberInput_Internal = function(stepValue, dp, onBegin, onChange, onFinish, onError) {
      ...
      if (!setCaretPos) {
        if (input.getElement().setSelectionRange) {
          setCaretPos = function(input2, pos) {
            input2.getElement().setSelectionRange(pos, pos);
          };
          selectAll = function(input2) {
            input2.getElement().setSelectionRange(0, input2.getProperty("value").length);
          };
        } else {
          setCaretPos = function(input2, pos) {
            var range = input2.getElement().createTextRange();
            range.collapse(true);
          ...
          selectAll = function(input2) {
            ...
            range.moveEnd("character", input2.getProperty("value").length);
            range.select();
          };
        }
      }
    ...
    NumberInput_Internal.prototype._setValue = function(value) {
      var prefix = ((value = +value) || 1 / value) < 0 && value == 0 ? "-" : "";
    ...
    NumberInput_Internal.prototype._onInput = function() {
      var input = this._input, value = input.getProperty("value"), start = input.getProperty("selectionStart"), dp = this._valueDp;
      var first = value[0];
      if (value == "") {
        value = 0;
      } else if (first === ".") {
    ...
    NumberInput_Internal.prototype._onKeydown = function(e) {
      ...
      var input = this._input, value = input.getProperty("value");
      var start = input.getProperty("selectionStart"), end = input.getProperty("selectionEnd");
      var length = value.length;
      var isBackspaceDelete = keyCode == 8 || keyCode == 45, isMetaKey = e.metaKey, isCtrlKey = e.ctrlKey, isLeft = keyCode == 37, isRight = keyCode == 39, isLeftRight = isLeft || isRight, isShift = e.shiftKey, isUpDown = keyCode == 38 || keyCode == 40, isSelectAll = (isMetaKey || isCtrlKey) && keyCode == 65, isRangeSelected = start != end, isAllSelected = start == 0 && end == length, isMinus = keyCode == 189;
      ...
      if (isUpDown) {
        var step = (isShift ? PRESET_SHIFT_MULTIPLIER : 1) * this._valueStep, mult = keyCode == 38 ? 1 : -1;
...
var require_NumberInput = __commonJS({
  "node_modules/controlkit/lib/component/NumberInput.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var NumberInput_Internal2 = require_NumberInput_Internal();
    var Node = require_Node();
    var Options = require_Options();
    var ButtonPreset = require_ButtonPreset();
    var CSS = require_CSS();
    ...
    var DEFAULT_INPUT_STEP = 1;
    var DEFAULT_INPUT_PRESET = null;
    function NumberInput(parent, object, value, params) {
      ...
      params.dp = params.dp === void 0 || params.dp == null ? DEFAULT_INPUT_DP : params.dp;
      ...
      var input = this._input = new NumberInput_Internal2(
        params.step,
        params.dp,
        params.onBegin,
...
var require_Range = __commonJS({
  "node_modules/controlkit/lib/component/Range.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var Node = require_Node();
    var NumberInput_Internal2 = require_NumberInput_Internal();
    var CSS = require_CSS();
    ...
    function Range(parent, object, value, params) {
      ...
      this._onChange = params.onChange;
      var step = this._step = params.step, dp = this._dp = params.dp;
      var labelMin = new Node();
      var inputMin = this._inputMin = new NumberInput_Internal2(
        step,
        dp,
      ...
      var inputMax = this._inputMax = new NumberInput_Internal2(
        step,
        dp,
        this.pushHistoryState.bind(this),
        this._onInputMaxChange.bind(this)
      );
      var labelMinWrap = new Node().setStyleClass(CSS.Wrap), inputMinWrap = new Node().setStyleClass(CSS.Wrap), labelMaxWrap = new Node().setStyleClass(CSS.Wrap), inputMaxWrap = new Node().setStyleClass(CSS.Wrap);
    ...
    Range.prototype._updateValueMin = function() {
      var values = this._obj[this._key];
      var inputMin = this._inputMin, inputValue = inputMin.getValue();
    ...
    Range.prototype._updateValueMax = function() {
      var values = this._obj[this._key];
      var inputMax = this._inputMax, inputValue = inputMax.getValue();
...
var require_Checkbox = __commonJS({
  "node_modules/controlkit/lib/component/Checkbox.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var Node = require_Node();
    var Event_ = require_Event();
    var NodeEvent = require_NodeEvent();
...
var require_Picker = __commonJS({
  "node_modules/controlkit/lib/component/Picker.js"(exports, module) {
    var Node = require_Node();
    var CSS = require_CSS();
    var NumberInput_Internal2 = require_NumberInput_Internal();
    var Mouse = require_Mouse();
    ...
    var DEFAULT_VALUE_SAT = 50;
    var DEFAULT_VALUE_VAL = 50;
    function Picker(parentNode) {
      var root = this._node = new Node().setStyleClass(CSS.Picker), head = this._headNode = new Node().setStyleClass(CSS.Head), labelWrap = new Node().setStyleClass(CSS.Wrap), label = new Node().setStyleClass(CSS.Label), menu = new Node().setStyleClass(CSS.Menu), menuWrap = new Node().setStyleClass(CSS.Wrap);
      var menuClose = new Node(Node.INPUT_BUTTON);
      menuClose.setStyleClass(CSS.ButtonMenuClose);
      var fieldWrap = new Node().setStyleClass(CSS.PickerFieldWrap), sliderWrap = new Node().setStyleClass(CSS.SliderWrap), inputWrap = new Node().setStyleClass(CSS.PickerInputWrap);
      var canvasField = this._canvasField = document.createElement("canvas"), canvasSlider = this._canvasSlider = document.createElement("Canvas");
      ...
      var contextCanvasField = this._contextCanvasField = canvasField.getContext("2d"), contextCanvasSlider = this._contextCanvasSlider = canvasSlider.getContext("2d");
      ...
      var step = 1, dp = 0;
      var callbackHue = this._onInputHueChange.bind(this), callbackSat = this._onInputSatChange.bind(this), callbackVal = this._onInputValChange.bind(this), callbackR = this._onInputRChange.bind(this), callbackG = this._onInputGChange.bind(this), callbackB = this._onInputBChange.bind(this);
      var inputHue = this._inputHue = new NumberInput_Internal2(step, dp, null, callbackHue), inputSat = this._inputSat = new NumberInput_Internal2(step, dp, null, callbackSat), inputVal = this._inputVal = new NumberInput_Internal2(step, dp, null, callbackVal), inputR = this._inputR = new NumberInput_Internal2(step, dp, null, callbackR), inputG = this._inputG = new NumberInput_Internal2(step, dp, null, callbackG), inputB = this._inputB = new NumberInput_Internal2(step, dp, null, callbackB);
      var controlsWrap = new Node().setStyleClass(CSS.PickerControlsWrap);
      var buttonPick = new Node(Node.INPUT_BUTTON).setStyleClass(CSS.Button).setProperty("value", "pick"), buttonCancel = new Node(Node.INPUT_BUTTON).setStyleClass(CSS.Button).setProperty("value", "cancel");
      var colorContrast = new Node().setStyleClass(CSS.PickerColorContrast);
      var color0 = this._colorCurrNode = new Node(), color1 = this._colorPrevNode = new Node();
      ...
      var inputFieldWrapHue = new Node().setStyleClass(CSS.PickerInputField), inputFieldWrapSat = new Node().setStyleClass(CSS.PickerInputField), inputFieldWrapVal = new Node().setStyleClass(CSS.PickerInputField);
      var inputFieldWrapHueLabel = new Node(Node.SPAN).setStyleClass(CSS.Label).setProperty("innerHTML", "H"), inputFieldWrapSatLabel = new Node(Node.SPAN).setStyleClass(CSS.Label).setProperty("innerHTML", "S"), inputFieldWrapValLabel = new Node(Node.SPAN).setStyleClass(CSS.Label).setProperty("innerHTML", "V");
      ...
      var inputFieldWrapR = new Node().setStyleClass(CSS.PickerInputField), inputFieldWrapG = new Node().setStyleClass(CSS.PickerInputField), inputFieldWrapB = new Node().setStyleClass(CSS.PickerInputField);
      var inputFieldWrapRLabel = new Node(Node.SPAN).setStyleClass(CSS.Label).setProperty("innerHTML", "R"), inputFieldWrapGLabel = new Node(Node.SPAN).setStyleClass(CSS.Label).setProperty("innerHTML", "G"), inputFieldWrapBLabel = new Node(Node.SPAN).setStyleClass(CSS.Label).setProperty("innerHTML", "B");
      ...
      var inputHEX = this._inputHEX = new Node(Node.INPUT_TEXT), inputFieldWrapHEX = new Node().setStyleClass(CSS.PickerInputField), inputFieldWrapHEXLabel = new Node(Node.SPAN).setStyleClass(CSS.Label);
      ...
      var eventMouseDown = NodeEvent.MOUSE_DOWN, callback = this._onCanvasFieldMouseDown.bind(this);
    ...
    Picker.prototype = {
      _drawHandleField: function() {
        var canvas = this._canvasField, nodePos = this._canvasFieldPos, mousePos = Mouse.get().getPosition();
        var posX = Math.max(0, Math.min(mousePos[0] - nodePos[0], canvas.width)), posY = Math.max(0, Math.min(mousePos[1] - nodePos[1], canvas.height)), posXNorm = posX / canvas.width, posYNorm = posY / canvas.height;
        var sat = Math.round(posXNorm * this._valueSatMinMax[1]), val = Math.round((1 - posYNorm) * this._valueValMinMax[1]);
      ...
      _updateHandleField: function() {
        var width = this._canvasField.width, height = this._canvasField.height, offsetHandle = this._handleFieldSize * 0.25;
        var satNorm = this._valueSat / this._valueSatMinMax[1], valNorm = this._valueVal / this._valueValMinMax[1];
      ...
      _drawHandleSlider: function() {
        var canvas = this._canvasSlider, canvasPosY = this._canvasSliderPos[1], mousePosY = Mouse.get().getY();
        var posY = Math.max(0, Math.min(mousePosY - canvasPosY, canvas.height)), posYNorm = posY / canvas.height;
      ...
      _updateHandleSlider: function() {
        var height = this._canvasSlider.height, offsetHandle = this._handleSliderHeight * 0.25;
        var hueNorm = this._valueHue / this._valueHueMinMax[1];
        this._handleSlider.setPositionGlobalY((height - offsetHandle) * (1 - hueNorm));
      },
      ...
      _onInputHueChange: function() {
        var input = this._inputHue, inputVal = this._getValueContrained(input, this._valueHueMinMax);
        var minMax = this._valueHueMinMax;
      ...
      _onInputHEXFinish: function() {
        var input = this._inputHEX, value = input.getProperty("value");
      ...
      _getValueContrained: function(input, minMax) {
        var inputVal = Math.round(input.getValue()), min = minMax[0], max = minMax[1];
        if (inputVal <= min) {
          inputVal = min;
          input.setValue(inputVal);
        }
      ...
      _onHeadDragStart: function() {
        var node = this._node, parentNode = this._parentNode;
        var nodePos = node.getPositionGlobal(), mousePos = Mouse.get().getPosition(), offsetPos = this._mouseOffset;
      ...
      _updatePosition: function() {
        var mousePos = Mouse.get().getPosition(), offsetPos = this._mouseOffset;
        var currPositionX = mousePos[0] - offsetPos[0], currPositionY = mousePos[1] - offsetPos[1];
        var node = this._node, head = this._headNode, position = this._position;
        var maxX = window.innerWidth - node.getWidth(), maxY = window.innerHeight - head.getHeight();
      ...
      _drawCanvasField: function() {
        var canvas = this._canvasField, context = this._contextCanvasField;
        var width = canvas.width, height = canvas.height, invWidth = 1 / width, invHeight = 1 / height;
        var imageData = this._imageDataField, rgb = [], index = 0;
        var valueHue = this._valueHue;
        var i = -1, j;
        while (++i < height) {
          j = -1;
          while (++j < width) {
            rgb = ColorUtil.HSV2RGB(valueHue, j * invWidth * 100, (1 - i * invHeight) * 100);
            index = (i * width + j) * 4;
      ...
      _drawCanvasSlider: function() {
        var canvas = this._canvasSlider, context = this._contextCanvasSlider;
        var width = canvas.width, height = canvas.height, invHeight = 1 / height;
        var imageData = this._imageDataSlider, rgb = [], index = 0;
        var i = -1, j;
        while (++i < height) {
          j = -1;
          while (++j < width) {
      ...
      _updateCanvasNodePositions: function() {
        var canvasSliderPos = this._canvasSliderPos, canvasFieldPos = this._canvasFieldPos;
...
var require_ColorFormatError = __commonJS({
  "node_modules/controlkit/lib/core/color/ColorFormatError.js"(exports, module) {
...
var require_Color = __commonJS({
  "node_modules/controlkit/lib/component/Color.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var Node = require_Node();
    var ColorMode = require_ColorMode();
    ...
    var NodeEvent = require_NodeEvent();
    var ComponentEvent = require_ComponentEvent();
    var ColorFormatError = require_ColorFormatError();
    var DEFAULT_COLOR_MODE = ColorMode.HEX;
    var DEFAULT_PRESETS = null;
    var MSG_COLOR_FORMAT_HEX = "Color format should be hex. Set colorMode to rgb, rgbfv or hsv.";
    var MSG_COLOR_FORMAT_RGB_RGBFV_HSV = "Color format should be rgb, rgbfv or hsv. Set colorMode to hex.";
    var MSG_COLOR_PRESET_FORMAT_HEX = "Preset color format should be hex.";
    var MSG_COLOR_PRESET_FORMAT_RGB_RGBFV_HSV = "Preset color format should be rgb, rgbfv or hsv.";
    function Color(parent, object, value, params) {
      ...
      if (!this._presetsKey) {
        ...
        var options = Options.get(), presetBtn = new ButtonPreset(wrap);
        var onPresetDeactivate = function() {
          options.clear();
          presetBtn.deactivate();
        };
    ...
    Color.prototype._onColorTrigger = function() {
      var colorMode = this._colorMode, colorModeHEX = ColorMode.HEX, colorModeRGB = ColorMode.RGB, colorModeRGBfv = ColorMode.RGBfv, colorModeHSV = ColorMode.HSV;
      var value = this._value, temp;
    ...
    Color.prototype._updateColor = function() {
      var color = this._value, colorNode = this._color, nodeColor;
...
var require_Button = __commonJS({
  "node_modules/controlkit/lib/component/Button.js"(exports, module) {
    var Event_ = require_Event();
    var NodeEvent = require_NodeEvent();
    var ComponentEvent = require_ComponentEvent();
    var Node = require_Node();
...
var require_Select = __commonJS({
  "node_modules/controlkit/lib/component/Select.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var Node = require_Node();
    var CSS = require_CSS();
    var Options = require_Options();
    ...
    function Select(parent, object, value, params) {
      ...
      this._onChange = params.onChange;
      var obj = this._obj, key = this._key;
      var targetKey = this._targetKey = params.target, values = this._values = obj[key];
    ...
    Select.prototype.applyValue = function() {
      var index = Options.get().getSelectedIndex(), selected = this._selected = this._values[index];
      if (this._hasTarget()) {
        this.pushHistoryState();
    ...
    Select.prototype.pushHistoryState = function() {
      var obj = this._obj, key = this._targetKey;
      History.get().pushState(obj, key, obj[key]);
    };
...
var require_Slider_Internal = __commonJS({
  "node_modules/controlkit/lib/component/Slider_Internal.js"(exports, module) {
    var Node = require_Node();
    var DocumentEvent = require_DocumentEvent();
    var NodeEvent = require_NodeEvent();
    var CSS = require_CSS();
    ...
    Slider_Internal.prototype._update = function() {
      var mx = Mouse.get().getX(), sx = this._slot.offsetX, sw = this._slot.width, px = mx < sx ? 0 : mx > sx + sw ? sw : mx - sx;
      this._handle.node.setWidth(Math.round(px));
      this._intrpl = px / sw;
      this._interpolateValue();
    };
    Slider_Internal.prototype._updateHandle = function() {
      var slotWidth = this._slot.width, handleWidth = Math.round(this._intrpl * slotWidth);
      this._handle.node.setWidth(Math.min(handleWidth, slotWidth));
    };
    Slider_Internal.prototype._interpolateValue = function() {
      var intrpl = this._intrpl, bounds = this._bounds;
    ...
    Slider_Internal.prototype._updateFromBounds = function() {
      var boundsMin = this._bounds[0], boundsMax = this._bounds[1];
...
var require_Slider = __commonJS({
  "node_modules/controlkit/lib/component/Slider.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var CSS = require_CSS();
    var Slider_Internal = require_Slider_Internal();
    var History = require_History();
    ...
    function Slider(parent, object, value, range, params) {
      ...
      params.step = params.step || DEFAULT_STEP;
      params.dp = params.dp === void 0 || params.dp == null ? DEFAULT_DP : params.dp;
      params.onChange = params.onChange || this._onChange;
      ...
      var values = this._values, obj = this._obj, targetKey = this._targetKey;
      var wrap = this._wrapNode;
    ...
    Slider.prototype._onInputChange = function() {
      var input = this._input, valueMin = this._values[0], valueMax = this._values[1];
...
var require_Pad = __commonJS({
  "node_modules/controlkit/lib/component/Pad.js"(exports, module) {
    var Plotter = require_Plotter();
    var Mouse = require_Mouse();
    var Event_ = require_Event();
    var DocumentEvent = require_DocumentEvent();
    ...
    Pad.prototype._drawGrid = function() {
      var svgSize = Number(this._svg.getAttribute("width")), svgMidX = Math.floor(svgSize * 0.5), svgMidY = Math.floor(svgSize * 0.5);
      var pathCmd = "";
    ...
    Pad.prototype._drawPoint = function() {
      ...
      var value = this._obj[this._key];
      var localX = (0.5 + value[0] * 0.5) * svgSize, localY = (0.5 + -value[1] * 0.5) * svgSize;
      var pathCmd = "";
    ...
    Pad.prototype._getMouseNormalized = function() {
      var offset = this._svgPos, mouse = Mouse.get().getPosition(), svgSize = Number(this._svg.getAttribute("width"));
      return [
        -1 + Math.max(0, Math.min(mouse[0] - offset[0], svgSize)) / svgSize * 2,
...
var require_Output = __commonJS({
  "node_modules/controlkit/lib/component/Output.js"(exports, module) {
    var ObjectComponent = require_ObjectComponent();
    var Node = require_Node();
    var CSS = require_CSS();
    var Metric = require_Metric();
    ...
    function Output(parent, object, value, params) {
      ...
      params.wrap = params.wrap === void 0 ? DEFAULT_WRAP : params.wrap;
      params.update = params.update === void 0 ? DEFAULT_UPDATE : params.update;
      this._wrap = params.wrap;
      this._update = params.update;
      var textArea = this._textArea = new Node(Node.TEXTAREA), wrap = this._wrapNode, root = this._node;
      ...
      if (params.height) {
        ...
        var height = this._height = params.height, padding = 4;
...
var require_NumberOutput = __commonJS({
  "node_modules/controlkit/lib/component/NumberOutput.js"(exports, module) {
    ...
    NumberOutput.prototype._setValue = function() {
      ...
      var value = this._obj[this._key], textArea = this._textArea, dp = this._valueDp;
      var index, out;
...
var require_StringOutput = __commonJS({
  "node_modules/controlkit/lib/component/StringOutput.js"(exports, module) {
    var Output = require_Output();
    ...
    StringOutput.prototype._setValue = function() {
      ...
      var textArea = this._textArea, textAreaElement = textArea.getElement(), textAreaScrollHeight;
...
var require_Canvas = __commonJS({
  "node_modules/controlkit/lib/component/Canvas.js"(exports, module) {
    var Component = require_Component();
    var CSS = require_CSS();
    var Metric = require_Metric();
    var Event_ = require_Event();
    ...
    Canvas.prototype._setCanvasSize = function(width, height) {
      var canvasWidth = this._canvasWidth = width, canvasHeight = this._canvasHeight = height;
...
var require_SVG = __commonJS({
  "node_modules/controlkit/lib/component/SVG.js"(exports, module) {
    var Component = require_Component();
    var CSS = require_CSS();
    var Metric = require_Metric();
    var GroupEvent = require_GroupEvent();
...
var require_Panel = __commonJS({
  "node_modules/controlkit/lib/group/Panel.js"(exports, module) {
    var Node = require_Node();
    var Group = require_Group();
    var ScrollBar = require_ScrollBar();
    var CSS = require_CSS();
    var LayoutMode = require_LayoutMode();
    var History = require_History();
    var EventDispatcher = require_EventDispatcher();
    var Event_ = require_Event();
    var DocumentEvent = require_DocumentEvent();
    var NodeEvent = require_NodeEvent();
    var PanelEvent = require_PanelEvent();
    var MenuEvent = require_MenuEvent();
    var Mouse = require_Mouse();
    var StringInput = require_StringInput();
    var NumberInput = require_NumberInput();
    var Range = require_Range();
    ...
    var Pad = require_Pad();
    var ValuePlotter = require_ValuePlotter();
    var NumberOutput = require_NumberOutput();
    var StringOutput2 = require_StringOutput();
    var Canvas_ = require_Canvas();
    var SVG_ = require_SVG();
    var DEFAULT_PANEL_POSITION = null;
    var DEFAULT_PANEL_WIDTH = 200;
    var DEFAULT_PANEL_HEIGHT = null;
    var DEFAULT_PANEL_WIDTH_MIN = 100;
    var DEFAULT_PANEL_WIDTH_MAX = 600;
    var DEFAULT_PANEL_RATIO = 40;
    var DEFAULT_PANEL_LABEL = "Control Panel";
    var DEFAULT_PANEL_VALIGN = LayoutMode.TOP;
    var DEFAULT_PANEL_ALIGN = LayoutMode.RIGHT;
    var DEFAULT_PANEL_DOCK = { align: LayoutMode.RIGHT, resizable: true };
    var DEFAULT_PANEL_ENABLE = true;
    var DEFAULT_PANEL_OPACITY = 1;
    var DEFAULT_PANEL_FIXED = true;
    var DEFAULT_PANEL_VCONSTRAIN = true;
    function Panel(controlKit, params) {
      ...
      params.fixed = params.fixed === void 0 ? DEFAULT_PANEL_FIXED : params.fixed;
      params.enable = params.enable === void 0 ? DEFAULT_PANEL_ENABLE : params.enable;
      params.vconstrain = params.vconstrain === void 0 ? DEFAULT_PANEL_VCONSTRAIN : params.vconstrain;
      if (params.dock) {
      ...
      this._enabled = params.enable;
      this._groups = [];
      var width = this._width, isFixed = this._fixed, dock = this._dock, position = this._position, label = this._label, align = params.align, opacity = params.opacity;
      var root = this._node = new Node().setStyleClass(CSS.Panel), head = this._headNode = new Node().setStyleClass(CSS.Head), menu = new Node().setStyleClass(CSS.Menu), labelWrap = new Node().setStyleClass(CSS.Wrap), label_ = new Node(Node.SPAN).setStyleClass(CSS.Label), wrap = this._wrapNode = new Node(Node.DIV).setStyleClass(CSS.Wrap), list = this._listNode = new Node(Node.LIST).setStyleClass(CSS.GroupList);
      root.setWidth(width);
      label_.setProperty("innerHTML", label);
      ...
      if (!dock) {
        ...
        if (!isFixed) {
          ...
          if (position) {
            var positionX = position[0], positionY = position[1];
      ...
      var historyIsEnabled = parent.historyIsEnabled(), statesAreEnabled = parent.statesAreEnabled();
    ...
    Panel.prototype._updateAppearance = function() {
      var rootNode = this._node, headNode = this._headNode, menuHide = this._menuHide;
      if (!this._enabled) {
    ...
    Panel.prototype._onHeadDragStart = function() {
      var parentNode = this._parent.getNode(), node = this._node;
      var nodePos = node.getPositionGlobal(), mousePos = Mouse.get().getPosition(), offsetPos = this._mouseOffset;
      offsetPos[0] = mousePos[0] - nodePos[0];
      offsetPos[1] = mousePos[1] - nodePos[1];
      var eventMouseMove = DocumentEvent.MOUSE_MOVE, eventMouseUp = DocumentEvent.MOUSE_UP;
    ...
    Panel.prototype._onWindowResize = function() {
      if (this.isDocked()) {
        ...
        if (dock.align == LayoutMode.RIGHT || dock.align == LayoutMode.LEFT) {
          var windowHeight = window.innerHeight, listHeight = this._listNode.getHeight(), headHeight = this._headNode.getHeight();
    ...
    Panel.prototype._constrainPosition = function() {
      var node = this._node;
      var maxX = window.innerWidth - node.getWidth(), maxY = window.innerHeight - node.getHeight();
      var position = this._position;
    ...
    Panel.prototype._constrainHeight = function() {
      ...
      var hasMaxHeight = this.hasMaxHeight(), hasScrollWrap = this.hasScrollWrap();
      var head = this._headNode, wrap = this._wrapNode;
      var scrollBar = this._scrollBar;
      ...
      var windowHeight = window.innerHeight, heightDiff = windowHeight - panelBottom - headHeight, heightSum;
      if (heightDiff < 0) {
    ...
    Panel.prototype._addScrollWrap = function() {
      var wrapNode = this._wrapNode, listNode = this._listNode, height = arguments.length == 0 ? this.getMaxHeight() : arguments[0];
    ...
    Panel.prototype.addStringOutput = function(object, value, params) {
      return this._addComponent(StringOutput2, object, value, params);
    };
    ...
    Panel.prototype.setData = function(data) {
      var groups = this._groups, i = -1, l = groups.length;
      while (++i < l) {
...
var require_State = __commonJS({
  "node_modules/controlkit/lib/core/State.js"(exports, module) {
    ...
    function createWindow() {
      ...
      var window_ = window.open("", "", "        width=" + width + ",        height=" + height + ",        left=" + (window.screenX + window.innerWidth * 0.5 - width * 0.5) + ",        top=" + (window.screenY + window.innerHeight * 0.5 - height * 0.5) + ",        location=0,        titlebar=0,        resizable=0");
    ...
    function save(data) {
      ...
      document_.getElementById("save").addEventListener("click", function() {
        var str = document_.getElementById("state").value, blob = new Blob([str], { type: "application:json" }), name = document_.getElementById("filename").value;
...
var require_Style = __commonJS({
  "node_modules/controlkit/lib/core/document/Style.js"(exports, module) {
    var Style = {
...
var require_ControlKit = __commonJS({
  "node_modules/controlkit/lib/ControlKit.js"(exports, module) {
    var Node = require_Node();
    ...
    var DEFAULT_PANELS_CLOSABLE = false;
    var DEFAULT_ENABLE = true;
    var DEFAULT_LOAD_AND_SAVE = false;
    var DEFAULT_TRIGGER_SHORTCUT_CHAR = "h";
    var initiated = false;
    function ControlKit2(options) {
      if (initiated) {
        throw new Error("ControlKit is already initialized.");
      }
      options = options || {};
      options.history = options.history === void 0 ? DEFAULT_HISTORY : options.history;
      options.loadAndSave = options.loadAndSave === void 0 ? DEFAULT_LOAD_AND_SAVE : options.loadAndSave;
      options.opacity = options.opacity === void 0 ? DEFAULT_OPACITY : options.opacity;
      options.panelsClosable = options.panelsClosable === void 0 ? DEFAULT_PANELS_CLOSABLE : options.panelsClosable;
      options.useExternalStyle = options.useExternalStyle === void 0 ? false : options.useExternalStyle;
      options.enable = options.enable === void 0 ? DEFAULT_ENABLE : options.enable;
      EventDispatcher.apply(this, arguments);
      var node = null;
      ...
      if (!options.useExternalStyle) {
        ...
        style.type = "text/css";
        var css = !options.style ? require_Style().string : options.styleString;
        if (style.stylesheet) {
      ...
      var self = this;
      var interval, count = 0, countMax = 10;
    ...
    ControlKit2.prototype = Object.create(EventDispatcher.prototype);
    ControlKit2.prototype.constructor = ControlKit2;
    ControlKit2.prototype.addPanel = function(params) {
      var panel = new Panel(this, params);
      this._panels.push(panel);
      return panel;
    };
    ControlKit2.prototype.update = function() {
      if (!this._enabled || !this._canUpdate) {
        return;
      }
      var i, j, k;
      var l, m, n;
      var panels = this._panels, panel, groups, components, component;
      i = -1;
      l = panels.length;
      while (++i < l) {
        panel = panels[i];
        ...
        while (++j < m) {
          ...
          while (++k < n) {
            ...
            if (component instanceof ValuePlotter || component instanceof StringOutput2 || component instanceof NumberOutput) {
              component.update();
            }
          }
        }
    ...
    ControlKit2.prototype.historyIsEnabled = function() {
      return this._historyEnabled;
    };
    ControlKit2.prototype.statesAreEnabled = function() {
      return this._statesEnabled;
    };
    ControlKit2.prototype.panelsAreClosable = function() {
      return this._panelsClosable;
    };
    ControlKit2.prototype._enable = function() {
    ...
    ControlKit2.prototype._disable = function() {
      var i = -1, p = this._panels, l = p.length;
      while (++i < l) {
        p[i].disable();
      }
    ...
    ControlKit2.prototype.enable = function() {
      this._enable();
      this._enabled = true;
    };
    ControlKit2.prototype.disable = function() {
      this._disable();
      this._enabled = false;
    };
    ControlKit2.prototype.setShortcutEnable = function(char) {
      this._shortcutEnable = char;
    };
    ControlKit2.prototype.onHistoryStatePush = function() {
      this.dispatchEvent(new Event_(this, MenuEvent.UPDATE_MENU, null));
    };
    ControlKit2.prototype.onHistoryStatePop = function() {
      this.dispatchEvent(new Event_(this, ComponentEvent.UPDATE_VALUE, { origin: null }));
      this.dispatchEvent(new Event_(this, MenuEvent.UPDATE_MENU, null));
    };
    ControlKit2.prototype.loadSettings = function(data) {
    ...
    ControlKit2.prototype._loadState = function() {
      State.load(this.loadSettings.bind(this));
    };
    ControlKit2.prototype._saveState = function() {
      this.update();
    ...
    ControlKit2.prototype.getNode = function() {
      return this._node;
    };
    ControlKit2.destroy = function() {
      Mouse.get().destroy();
      Options.get().destroy();
      Picker.get().destroy();
      initiated = false;
    };
    module.exports = ControlKit2;
  }
});

// node_modules/controlkit/index.js
var require_controlkit = __commonJS({
  "node_modules/controlkit/index.js"(exports, module) {
    var ControlKit2 = require_ControlKit();
    ControlKit2.Canvas = require_Canvas();
    ControlKit2.SVG = require_SVG();
    module.exports = ControlKit2;
  }
});
export default require_controlkit();
//# sourceMappingURL=controlkit.js.map
